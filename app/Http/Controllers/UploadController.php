        ...
        if (file_exists($originalPath)) {
            ...
            if ($fileExtension !== 'gif') {
                ...
                if ($imageWidth < 300) {
                    ...
                    $webpPath320 = public_path(env('UPLOADS_DIRECTORY')) . '/' . $webpFileName320;
                    $webpPath480 = public_path(env('UPLOADS_DIRECTORY')) . '/' . $webpFileName480;
                    $webpPath800 = public_path(env('UPLOADS_DIRECTORY')) . '/' . $webpFileName800;
                    ...
                    $urlWebp320 = url(env('UPLOADS_DIRECTORY') . '/' . $webpFileName320);
                    $urlWebp480 = url(env('UPLOADS_DIRECTORY') . '/' . $webpFileName480);
                    $urlWebp800 = url(env('UPLOADS_DIRECTORY') . '/' . $webpFileName800);
                }
            }
